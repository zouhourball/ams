        ...
        <CustomExpansionPanel
          ...
          body={
            <>
              {role !== 'admin' && (
                <div>
                  <h2 className="new-agreement-title">
                    {' '}
                    {newAgreementData.title}
                  </h2>
                  <h3 className="new-agreement-sub-title">
                    {' '}
                    {t('description')}{' '}
                  </h3>
              ...
              {!agreementId ? (
                <>
                  <TextField
                    ...
                    autoComplete="off"
                    className={`${
                      newAgreementError.title && 'error'
                    } new-agreement-textField`}
                  />
                  <HtmlEditor
                    editorLabel={'Description'}
                    value={newAgreementData.description}
                    onChange={(value) =>
                      handleNewAgreementData('description', value)
                    }
                    editorLabelClassName="new-agreement-label"
                    wrapperClassName={`${
                      newAgreementError.description && 'error'
                    } new-agreement-description`}
                    stopEditing={true}
                    // maxLength={100}
                  />
                  <HtmlEditor
