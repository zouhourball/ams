...
import { surplusRecordDetailsConfigs } from '../helpers'
import { Button, FontIcon } from 'react-md'
import useRole from 'libs/hooks/use-role'
import '../style.scss'
const SurplusRecordDetail = () => {
  ...
  const acceptedTransactionMutation = useMutation(acceptedTransaction, {
    onSuccess: (res) => {
      if (!res.error) {
        ...
        navigate(
          `/ams/inventory/inventory-surplus-records/${inventoryId}/base-consumption`,
        )
  ...
  return (
    <div className="details-container">
      <TopBarDetail
        ...
        detailData={{ title: 'Surplus Record Detail' }}
        actions={[
          role === 'regulator' && (
            <>
              <Button
      ...
      />
      <Mht
        configs={surplusRecordDetailsConfigs()}
...
export default SurplusRecordDetail
